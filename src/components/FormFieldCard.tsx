...
function DatePickerPreview() {
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="w-auto p-0 bg-white border shadow-md" align="start" style={{ zIndex: 9999 }}>
        <Calendar
          mode="single"
          selected={date}
          onSelect={setDate}
        ...
        <div className="xform-field-header-main" onClick={onToggleExpand}>
          ...
          {isPhone && (
            <div className="xform-verify-badge" onClick={(e) => e.stopPropagation()}>
              ...
              />
              <span className="xform-verify-text" onClick={() => updateField({ phoneConfig: { ...phoneConfig, requireVerification: !phoneConfig.requireVerification } })}>需認證</span>
          ...
          {isDate && (
            <div className="xform-form-group">
              ...
              <div className="xform-date-display-mode-row">
                ...
                <select
                  className="form-select form-select-sm xform-date-display-select"
                  value={dateConfig.displayMode || "calendar"}
                  onChange={(e) => updateField({ dateConfig: { ...dateConfig, displayMode: e.target.value as "calendar" | "combo" } })}
                >
              ...
              {dateConfig.displayMode === "combo" && (
                <>
                  <div className="xform-date-combo-row" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 8, marginBottom: 8, flexWrap: 'wrap', gap: '0.5rem' }}>
                    <div className="xform-date-checks" style={{ margin: 0 }}>
                    ...
                    {dateConfig.includeYear && (() => {
                      ...
                      return (
                        <div className="xform-date-year-range-inline" style={{ marginLeft: 'auto' }}>
